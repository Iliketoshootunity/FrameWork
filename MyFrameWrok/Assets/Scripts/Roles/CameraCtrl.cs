...
public class CameraCtrl : MonoBehaviour {
    ...
    {
        CameraRotate.Rotate(0, 20 * Time.deltaTime * (type == 0 ? 1 : -1),0);
    }

    public void SetCameraUpAndDown(int type)
    {
        CameraUpAndDown.Rotate(0, 0,20 * Time.deltaTime * (type == 0 ? 1 : -1));
    ...
    public void SetCameraZoom(int type)
    {
        ...
        CameraZoom.localPosition= new Vector3(0, 0, Mathf.Clamp(CameraZoom.localPosition.z, -2, 2));
    }
    ...
    void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(transform.position, 7.82f);
    }
}
